...
Obtiene una lista paginada de artículos que sean Equipos, son datos del inventario. Cada artículo incluye códigos de identificación, categorización, niveles de stock, tiempos de reposición (*lead times*) e información de precios.
...
`GET http://api.energy.keops-corp.com/itemInfo_equipo/`
